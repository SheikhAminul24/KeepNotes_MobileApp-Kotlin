...
class SaveEditFragment : Fragment() {
        ...
        val callback = object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                if (etTitle.text.toString().isEmpty()
                    && etNoteContent.text.toString().isEmpty()
                    && noteId == null
                ) {

                    Navigation.findNavController(view!!)
                        .navigate(R.id.action_saveEditFragment_to_noteFragment)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.apply {
            noteContentFragmentParent = findViewById(R.id.notContentFragmentParent)
 ...
 noteId=arguments?.getString("noteId")
    ...
    private fun saveNote() {
        ...
        if (etTitle.text.toString().isEmpty()
            ...
            val documentReference: DocumentReference = FirebaseFirestore.getInstance().collection("notes").document(FirebaseAuth.getInstance().uid.toString())
                .collection("myNotes").document()
